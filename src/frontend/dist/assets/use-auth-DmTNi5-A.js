...
import { l as ProtocolError, T as TimeoutWaitingForResponseErrorCode, m as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, n as lookupResultToBuffer, o as RequestStatusResponseStatus, U as UnknownError, p as RequestStatusDoneNoReplyErrorCode, q as RejectError, s as CertifiedRejectErrorCode, t as UNREACHABLE_ERROR, I as InputError, v as InvalidReadStateRequestErrorCode, w as ReadRequestType, x as Principal, y as IDL, z as MissingCanisterIdErrorCode, H as HttpAgent, A as encode, Q as QueryResponseStatus, B as UncertifiedRejectErrorCode, D as isV3ResponseBody, F as isV2ResponseBody, G as UncertifiedRejectUpdateErrorCode, J as UnexpectedErrorCode, K as decode, S as Subscribable, N as pendingThenable, O as resolveEnabled, V as shallowEqualObjects, W as resolveStaleTime, X as noop, Y as environmentManager, Z as isValidTimeout, _ as timeUntilStale, $ as timeoutManager, a0 as focusManager, a1 as fetchState, a2 as replaceData, a3 as notifyManager, a4 as hashKey, a5 as getDefaultState, r as reactExports, a6 as shouldThrowError, e as useQueryClient, k as useInternetIdentity, a7 as createActorWithConfig, j as jsxRuntimeExports, g as React, a8 as clsx, f as cn, a9 as Record, aa as Opt, ab as Variant, ac as Vec, ad as Service, ae as Func, af as Nat, ag as Text, ah as Nat8, ai as Null, aj as Bool, ak as Int, al as Principal$1 } from "./index-Bee7OgJo.js";
...
const CategoryInput = Record({
  "name": Text,
  "description": Text,
  "parentCategoryId": Opt(CategoryId)
});
const Timestamp = Int;
...
const CategoryWithCount = Record({
  ...
  "productCount": Nat,
  "parentCategoryId": Opt(CategoryId),
  "ancestorPath": Vec(CategoryAncestor)
});
...
Service({
  ...
  "createCategory": Func([CategoryInput], [Category], []),
  "createCheckoutSession": Func(
    [Vec(ShoppingItem), Text, Text],
    [Text],
    []
  ),
  "createOrderFromSession": Func([Text, OrderInput], [Order], []),
  ...
  "getCategories": Func([], [Vec(CategoryWithCount)], ["query"]),
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const CategoryInput2 = IDL2.Record({
    ...
    "parentCategoryId": IDL2.Opt(CategoryId2)
  });
  ...
  const CategoryAncestor2 = IDL2.Record({ "id": CategoryId2, "name": IDL2.Text });
  const CategoryWithCount2 = IDL2.Record({
    ...
    "parentCategoryId": IDL2.Opt(CategoryId2),
    "ancestorPath": IDL2.Vec(CategoryAncestor2)
  });
  ...
  return IDL2.Service({
    ...
    "createCategory": IDL2.Func([CategoryInput2], [Category2], []),
    "createCheckoutSession": IDL2.Func(
      [IDL2.Vec(ShoppingItem2), IDL2.Text, IDL2.Text],
      [IDL2.Text],
      []
    ),
    "createOrderFromSession": IDL2.Func([IDL2.Text, OrderInput2], [Order2], []),
    ...
    "getCategories": IDL2.Func([], [IDL2.Vec(CategoryWithCount2)], ["query"]),
...
class Backend {
  ...
  async createOrderFromSession(arg0, arg1) {
    if (this.processError) {
      try {
...
function from_candid_CategoryWithCount_n30(_uploadFile, _downloadFile, value) {
  return from_candid_record_n31(_uploadFile, _downloadFile, value);
}
function from_candid_Category_n12(_uploadFile, _downloadFile, value) {
...
async function from_candid_Product_n22(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n23(_uploadFile, _downloadFile, value);
}
function from_candid_StripeSessionStatus_n36(_uploadFile, _downloadFile, value) {
...
async function from_candid_opt_n24(_uploadFile, _downloadFile, value) {
...
async function from_candid_vec_n35(_uploadFile, _downloadFile, value) {
  return await Promise.all(value.map(async (x) => await from_candid_Product_n22(_uploadFile, _downloadFile, x)));
}
function to_candid_CategoryInput_n10(_uploadFile, _downloadFile, value) {
  return to_candid_record_n11(_uploadFile, _downloadFile, value);
}
async function to_candid_ExternalBlob_n21(_uploadFile, _downloadFile, value) {
...
async function to_candid_ProductInput_n19(_uploadFile, _downloadFile, value) {
